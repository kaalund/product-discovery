# Discovery Skills Bundle

Ten skills for structured product discovery — from problem framing to stakeholder communication. Built on the frameworks of Cagan, Perri, Torres, and Brown.

All skills respond to **English and Norwegian**. Use whichever you're thinking in.
...
> *"Help me with discovery"* · *"Discovery kickoff"* · *"Where do I start?"*
...
### `discovery-guide` — Orient and route
Runs an intake conversation, produces a situational map (what you know, what you don't, whether you have authority to act), and recommends a next step. The only skill that can conclude discovery shouldn't happen yet.

> *"Help me with discovery"* · *"We're starting discovery on X"* · *"Am I working on the right thing?"* · *"Discovery check-in"*
...
### `outcome-framing` — Define success
Builds an outcome statement, metrics framework, and OKRs. Challenges vanity metrics, output-based success definitions, and metrics that could improve even if users are failing.

> *"Define success metrics"* · *"Help me write OKRs"* · *"How will we know if this worked?"* · *"What should our north star metric be?"*
...
### `assumption-mapping` — Surface and test assumptions
Generates an assumption map across Cagan's four risk types (value, usability, feasibility, viability), prioritizes by risk and confidence, and designs experiments for the most dangerous assumptions. Run this before planning research or exploring solutions.

> *"Map our assumptions"* · *"What are the riskiest assumptions?"* · *"Design an experiment for this"* · *"What are we betting on?"*
...
discovery-guide          → orient, map where you are
  ...
  research-planner       → design research to reduce the biggest risks
  research-synthesis     → extract insight from what you found
  solution-exploration   → generate and evaluate directions
